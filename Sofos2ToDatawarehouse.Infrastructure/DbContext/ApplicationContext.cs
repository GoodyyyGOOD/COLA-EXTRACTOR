...
namespace Sofos2ToDatawarehouse.Infrastructure.DbContext
{
    public class ApplicationContext : IDisposable
    {
        ...
        public ApplicationContext(string dbSource, StringBuilder argSQLCommand = null, Dictionary<string, object> argSQLParam = null)
        {
            try
            {
        ...
        //                    Properties.Settings.Default.SOURCE_DB,
