                    ...
                    using (var dr = conn.MySQLReader())
                    {
                        while (dr.Read())
                        {
                            result.Add(new ColaTransactionDetail
                            {
                                ...
                                Barcode = dr["barcode"] == DBNull.Value ? null : dr["barcode"].ToString(),
                                ItemCode = dr["itemCode"] == DBNull.Value ? null : dr["itemCode"].ToString(),
                                ItemDescription = dr["itemDescription"] == DBNull.Value ? null : dr["itemDescription"].ToString(),
                                UnitOfMeasureCode = dr["uomCode"] == DBNull.Value ? null : dr["uomCode"].ToString(),
                                UnitOfMeasureDescription = dr["uomDescription"] == DBNull.Value ? null : dr["uomDescription"].ToString(),
