...
using static Sofos2ToDatawarehouse.Infrastructure.Queries.Accounting.AccountingQuery;
    ...
    public class AccountingRepository
    {
        ...
        private List<AccountDetails> GetAccountingHeader(int lastTransnum, int maxFetchLimit)
        {
            try
            {
                ...
                using (var conn = new ApplicationContext(_dbSource, AccountingQuery.GetAccountingQuery(AccountingEnum.AccountingHeader), param))
                {
