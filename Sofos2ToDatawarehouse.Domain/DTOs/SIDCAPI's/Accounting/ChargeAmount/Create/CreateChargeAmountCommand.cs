...
namespace Sofos2ToDatawarehouse.Domain.DTOs.SIDCAPI_s.Accounting.ChargeAmount.Create
{
    public class CreateChargeAmountCommand
    {
        ...
        //public int ColaId { get; set; }
        //public ICollection<CreateChargeAmountDetailCommand> ChargeAmountDetail { get; set; }
    }
    //public class CreateChargeAmountDetailCommand
    //{
