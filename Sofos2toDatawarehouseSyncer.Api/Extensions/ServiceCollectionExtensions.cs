using Sofos2toDatawarehouseSyncer.Api.Services;
using Sofos2toDatawarehouseSyncer.Application.DTOs.Settings;
using Sofos2toDatawarehouseSyncer.Application.Interfaces;
...
using Sofos2toDatawarehouseSyncer.Infrastructure.Identity.Services;
using Sofos2toDatawarehouseSyncer.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\Sofos2toDatawarehouseSyncer.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "Sofos2toDatawarehouseSyncer",
