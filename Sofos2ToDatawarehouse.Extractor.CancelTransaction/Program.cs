using Sofos2ToDatawarehouse.Extractor.CancelTransaction.Controller;
using System;
...
namespace Sofos2ToDatawarehouse.Extractor.CancelTransaction
{
    internal class Program
    {
        private static async Task Main(string[] args)
        {
            ...
            else
            {
                try
                {
                    System.Console.WriteLine("The cancel transaction extractor will now begin.");
